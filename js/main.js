document.addEventListener('DOMContentLoaded', () => {
  const showMenu = (toggleId, navId) => {
    ...
    if (toggle && nav) {
      ...
      console.error('Error: Element(s) not found! Check your IDs.');
    }
  };
...
function swiperCode() {
  ...
  var swiper = new Swiper('.swiper', {
    ...
    freeMode: true,
    mousewheel: {
      releaseOnEdges: true, // Allows page scroll after swiper edge
    },
    touch: {
  ...
  // $(window).scroll(function () {
    ...
    // if(header_paralaxBlack)
      ...
      if( !(value2 >= 790) ) {
        ...
        sun_black.style.transform = `translateY(${value2 * 0.015}%)`;
        ...
        header_text_black_laptop.style.transform = `translateY(${value2 * 0.025}%)`;
        sun_black_laptop.style.transform = `translateY(${value2 * 0.02}%)`;
      }
      ...
      if( !(value >= 790) ) {
        ...
        sun.style.transform = `translateY(${value * 0.015}%)`;
        ...
        header_text_laptop.style.transform = `translateY(${value * 0.025}%)`;
        sun_laptop.style.transform = `translateY(${value * 0.02}%)`;
      }
